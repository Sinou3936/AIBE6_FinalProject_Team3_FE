...
| user              | 1개 (2026-08-21 갱신, 16개 중 15개 해결/결정 완료 — "취업 여부"도 콘텐츠 차별화 전제(위젯 재배치)가 폐기되면서 다루지 않기로 결정됨. 추가로 홈/마이페이지 데이터 조회 순차 실행으로 인한 로딩 지연(화면 깜빡임 피드백)을 병렬화로 해결하고, 마이페이지 "등록 매물" 목록에 페이지네이션 적용 완료. 남은 건 property/checklist 세션 리다이렉트(스코프 밖) 1건뿐 — `user-design.md` 참고) |
| property          | 6개                                                                                                                                                                                                                                                                                              |
| market-data       | 4개                                                                                                                                                                                                                                                                                              |
