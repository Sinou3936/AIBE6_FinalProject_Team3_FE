...
| `checklist` | 거의 완전 구현 | **(2026-07-29 갱신)** 확인 필요 3개로 축소 — Backend가 정렬/삭제매물 재검증 문제를 둘 다 해결(자동 반영됨), 403 메시지 구체화는 실사용 경로가 없어 보류로 결론. 남은 건 필수/일반 미구분 표시, risk-analysis 연계 자리 없음, 클라이언트 사이드 Access Token 만료 취약점 |
...
| property | 6개 |
| market-data | 4개 |
| checklist | 3개 (2026-07-29 갱신, 위 표 참고) |
