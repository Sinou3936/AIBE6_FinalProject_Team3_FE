...
| 건물명(아파트/오피스텔명 등)으로 검색 | ✅ **(2026-08-21 추가, #264/#197, 5차 멘토링 피드백 6-3)** "상세 필터" 패널에 건물명 입력란 추가 — `title` 쿼리파라미터로 BE `PropertySearchCondition.title`(부분일치 LIKE)에 전달됨. region(주소)과 독립된 별도 조건 |
